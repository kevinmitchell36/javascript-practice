...
const youngPeople = people
  ...
  .map(function(youngin) {
    return {
      name: `${youngin.firstName} ${youngin.lastName}`,
      email: youngin.email
    }
  })

console.log('The younger people are:' , youngPeople);
...
const positiveSum = numbers
  ...
  .reduce( (acc, positives) => acc + positives, 0)
console.log('Filter and reduce the positive numbers:', positiveSum);
